          ...
          <div id="sidebar-menu" className="sidebar-menu">
            <nav className="greedys sidebar-horizantal">
              <ul className="list-inline-item list-unstyled links">
                ...
                <li className="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <NavLink to="/DealsDashboard">
                        <a>Deals Dashboard</a>
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/LeadsDashboard">
                        <a>Leads Dashboard</a>
                      </NavLink>
                    </li>
                    <li>
                ...
                <li className="submenu">
                  <a href="#">
                    <i className="la la-ticket"></i> <span> Crm</span>
                    <span className="menu-arrow"> </span>
                  </a>
                  <ul>
                    <li>
                ...
                <li className="submenu">
                  <a href="#">
                    <i className="la la-files-o"></i> <span> Sales </span>
                    <span className="menu-arrow"></span>
                  </a>
                  <ul>
                    {/* <li>
              ...
              <ul className="hidden-links hidden">
                ...
                <li className="submenu">
                  <a href="#">
                    <i className="la la-dropbox"></i> <span> Advanced UI </span>
                    <span className="menu-arrow"></span>
                  </a>
                  <ul>
                    <li>
                ...
                <li className="submenu">
                  <a href="#">
                    <i className="la la-chart-bar"></i> <span> Charts </span>
                    <span className="menu-arrow"></span>
                  </a>
                  <ul>
                    <li>
                ...
                <li className="submenu">
                  <a href="#">
                    <i className="la la-icons"></i> <span> Icons </span>
                    <span className="menu-arrow"></span>
                  </a>
                  <ul>
                    <li>
                ...
                <li>
                  <a href="javascript:void(0);">
                    ...
                    <span className="badge badge-primary ms-auto">v4.0</span>
                  </a>
                </li>
                <li className="submenu">
                  <a href="javascript:void(0);">
            ...
            {/* <ul className="sidebar-vertical">
              ...
              <li>
                <a href="contact-list.html">
                  <i className="la la-user-shield"></i> <span> Contacts </span>
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="deals.html">
                  <i className="la la-cubes"></i> <span> Deals </span>
                </a>
              </li>
              <li>
                <a href="leads.html">
                  <i className="la la-chart-area"></i> <span> Leads </span>
                </a>
              </li>
              <li>
                <a href="pipeline.html">
                  <i className="la la-exchange-alt"></i> <span> Pipeline </span>
                </a>
              </li>
              <li>
                <a href="analytics.html">
                  <i className="la la-dice"></i> <span> Analytics </span>
                </a>
              </li>
              <li>
                <a href="activities.html">
                  <i className="la la-directions"></i> <span> Activities </span>
                </a>
              </li>
              <li className="menu-title">
                <span>HR</span>
              ...
              <li className="submenu">
                <a href="#">
                  <i className="la la-file-alt"></i> <span> Accounting </span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li>
              ...
              <li className="submenu">
                <a href="#">
                  <i className="la la-money-bill-wave"></i>{" "}
                  <span> Payroll </span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
              ...
              <li>
                <a href="policies.html">
                  <i className="la la-file-pdf"></i> <span>Policies</span>
                </a>
              </li>
              <li className="submenu">
                <a href="#">
                  <i className="la la-chart-pie"></i> <span> Reports </span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li>
              ...
              <li className="submenu">
                <a href="#">
                  <i className="la la-laptop-medical"></i>
                  <span> Performance </span>{" "}
                  <span className="menu-arrow"></span>
                </a>
                <ul>
              ...
              <li className="submenu">
                <a href="#">
                  <i className="la la-user-times"></i> <span>Termination</span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li>
              ...
              <li>
                <a href="users.html">
                  <i className="la la-users-cog"></i> <span>Users</span>
                </a>
              </li>
              <li>
                <a href="settings.html">
              ...
              <li className="submenu">
                <a href="#">
                  <i className="la la-user-tag"></i> <span> Profile </span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li>
              ...
              <li className="submenu">
                <a href="#">
                  <i className="la la-history"></i> <span> Subscriptions </span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li>
              ...
              <li className="submenu">
                <a href="#">
                  <i className="lab la-uikit"></i> <span> Base UI </span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li>
              ...
              <li className="submenu">
                <a href="#">
                  <i className="la la-eject"></i> <span> Advanced UI </span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li>
              ...
              <li className="submenu">
                <a href="#">
                  <i className="la la-chart-line"></i> <span> Charts </span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li>
              ...
              <li className="submenu">
                <a href="#">
                  <i className="la la-wpforms"></i> <span> Forms </span>
                  <span className="menu-arrow"></span>
                </a>
                <ul>
                  <li>
              ...
              <li>
                <a href="#">
                  <i className="la la-file-alt"></i> <span>Documentation</span>
                </a>
              </li>
              <li>
                <a href="javascript:void(0);">
              ...
              <li className="submenu">
                <a href="javascript:void(0);">
                  <i className="la la-level-up-alt"></i>{" "}
